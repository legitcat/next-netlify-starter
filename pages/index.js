        ...
        <div>
          ...
          <main> 
             <div className="brick">
                ...
                <div className="both1">
                   <a href="https://pvpython.pythonanywhere.com"><div className='side2'>Python&bsp;</div></a>
                   <a href="https://pvpython.pythonanywhere.com"><div className='side1'>&bsp;MySql</div></a>
